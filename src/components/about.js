...
// const first = "Hello and welcome to my website! My name is Alexandru Rasiga and I am a third year student at the University of Waterloo studying Computer Enginering! I've built this website from the ground up to facilitate my introduction and create a portal where anybody can learn more about me. This page is built from scratch using React.js in conjunction with Amazon's Web Services (AWS). I am very passionate about software development as a whole and I strive to learn more and more about the subject everyday."
// const second = "Some interesting facts about me include: I am trilingual (English, French, and Romanian), I've played soccer all my life (including )"
